...
| `references`.`visible`      | Define if attribute reference is visible. The visible attributes  need to be mandatories in product. This visible attributes are used to generete the visibles references |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| :---------------------------- | :----------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `id`                          | Product id                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `urn`| `String` readable unique reference for a tenant ||
| `visibleRef`|  configurable readable reference for root product. No need to be unique in tenant||
| `version`                     | Version to manage concurrence                                                                                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `state`                      | State of product root. It has a predefined common machine for all products                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `variants.urn`|  Readable identifier for a variant unique in tenant. ||
| `variants.visibleRef`| Readable identifier. No need to be unique in tenant. It has the visisble attributes(product and variant) of visible referece definition attributes ||
...
| `variants.marks`             | `Array` List of custom marks defined in product schema implemented for a variant                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
